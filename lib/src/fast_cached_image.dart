...
class _FastCachedImageState extends State<FastCachedImage> with TickerProviderStateMixin {
              ...
              child: Image.memory(
                ...
                errorBuilder: (a, c, v) {
                  if (_animationController.status != AnimationStatus.completed) {
                    ...
                    _logErrors(c);
                    FastCachedImageConfig.deleteCachedImage(imageUrl: widget.url, showLog: widget.showErrorLog);
                  }
  ...
  Future<void> _loadAsync(String url, Map<String, dynamic>? headers) async {
    ...
    try {
      ...
      Response response = await dio.get(url, options: Options(responseType: ResponseType.bytes, headers: headers),
